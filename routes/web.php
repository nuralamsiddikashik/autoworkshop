...
Route::prefix('invoices')->name('invoices.')->controller(InvoiceController::class)
    ->group(function () {
        ...
        Route::get('/hidden-list', 'hiddenIndex')->name('hidden.index');
        Route::post('/hidden-list/unlock', 'unlockHiddenIndex')->name('hidden.unlock');
        Route::post('/hidden-list/lock', 'lockHiddenIndex')->name('hidden.lock');
        ...
        Route::patch('/hide/{id}', 'hide')->name('hide');
